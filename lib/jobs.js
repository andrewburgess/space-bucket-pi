    ...
    .then((image) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            gm(image, filename)
                ...
                .font('Arial')
                .fontSize(28)
                .drawText(11, 533, `Temperature: ${_.round(values.temperature, 1)} °C`)
                .drawText(11, 565, `Humidity: ${_.round(values.humidity, 1)}%`)
                .drawText(11, 597, `Pressure: ${_.round(values.pressure, 1)} hPa`)
                .drawText(11, 651, date)
                .drawText(11, 681, time)
                .fill('white')
                .drawText(10, 532, `Temperature: ${_.round(values.temperature, 1)} °C`)
                .drawText(10, 564, `Humidity: ${_.round(values.humidity, 1)}%`)
                .drawText(10, 596, `Pressure: ${_.round(values.pressure)} hPa`)
                .drawText(10, 650, date)
                .drawText(10, 680, time)
